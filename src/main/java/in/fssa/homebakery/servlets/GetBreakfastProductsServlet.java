...
/**
 * Servlet implementation class GetBreakfastProductsServlet
 */
@WebServlet("/breakfastpastries")
public class GetBreakfastProductsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
		    ...
		    productList = prodService.getSetByCategoryId(3,(pageNo-1) * total);
			
			int totalPages = prodService.getCountOfActiveProductsByCategoryId(2);
			
			request.setAttribute("category", "breakfast");
